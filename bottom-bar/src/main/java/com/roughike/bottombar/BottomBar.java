...
public class BottomBar extends LinearLayout implements View.OnClickListener, View.OnLongClickListener {
    ...
    //手动传BottomBarTab对象给BottomBar
    private List<BottomBarTab> bottomBarItems;

    //提供getter、setter方法
    public List<BottomBarTab> getBottomBarItems() {
        return bottomBarItems;
    }

    public void setBottomBarItems(List<BottomBarTab> bottomBarItems) {
    ...
    private void populateAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            int defaultActiveColor = isShiftingMode() ? Color.WHITE : MiscUtils.getColor(getContext(), R.attr.colorAccent);;
